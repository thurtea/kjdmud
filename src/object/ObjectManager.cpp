...
#include "kjdmud/compiler/Lexer.hpp"
#include "kjdmud/compiler/Parser.hpp"
#include "kjdmud/compiler/CodeGen.hpp"
...
PreprocessResult runPreprocessor(const std::string& sourcePath, const std::vector<std::string>& includeDirs,
    ...
    char errPathTemplate[] = "/tmp/kjdmud_cpp_stderr_XXXXXX";
