...
Persistent world state - kjdmud exceeds DGD by supporting *both*
world-level snapshots and per-object `save_object()`/`restore_object()`
simultaneously. DGD forces you to choose one; kjdmud supports both.
...
### `include/kjdmud/persist/SwapManager.hpp`
...
### `include/kjdmud/persist/HotbootManager.hpp`
