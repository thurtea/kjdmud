...
- `include/kjdmud/vm/Value.hpp` - the full `ValueVariant` definition
- `include/kjdmud/vm/Bytecode.hpp` - every OpCode and CompiledProgram
- `include/kjdmud/vm/VM.hpp` - public VM API
