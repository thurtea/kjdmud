...
kjdmud is a from-scratch LPC game driver written in C++20. It already has a lexer, parser, bytecode compiler, VM, object system, and network stack for telnet, TLS, and WebSocket.
...
- TMI-2, already booted once on kjdmud
